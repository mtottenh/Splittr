...
- **Status:** Accepted for the transport choice (iroh).
  **Superseded in part:** the "core stays pure Dart" premise is superseded by
  **ADR-0003** (Accepted — Rust-core engine). iroh is now consumed **in-process**
  by the Rust core rather than behind a sub-FFI.
- **Date:** 2026-06-20
