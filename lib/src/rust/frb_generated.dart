...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 773044457;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiEngineAddFriend({
    required Engine that,
  ...
  Future<void> crateApiEngineAuthorizeDevice({
    required Engine that,
    required String deviceHex,
    required BigInt site,
  });

  Future<void> crateApiEngineClaimPerson({
    required Engine that,
    required String placeholder,
  });

  Future<List<String>> crateApiEngineConfirmedFriends({required Engine that});

  Future<Uint8List> crateApiEngineCreateFriendInvite({
    required Engine that,
  ...
  Future<Uint8List> crateApiEngineCreateGroupInvite({
    required Engine that,
    required String groupId,
    required BigInt expiryMs,
  });
  ...
  Future<void> crateApiEngineMergePeople({
    required Engine that,
  ...
  Future<void> crateApiEngineRevokeDevice({
    required Engine that,
    required String deviceHex,
  });
  ...
  Future<InviteDto?> crateApiVerifyInvite({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiEngineAddFriend({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiEngineAddFriendConstMeta,
  ...
  TaskConstMeta get kCrateApiEngineAddFriendConstMeta => const TaskConstMeta(
    debugName: "Engine_add_friend",
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(deviceHex, serializer);
        ...
        constMeta: kCrateApiEngineAuthorizeDeviceConstMeta,
        argValues: [that, deviceHex, site],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiEngineAuthorizeDeviceConstMeta =>
      const TaskConstMeta(
        debugName: "Engine_authorize_device",
        argNames: ["that", "deviceHex", "site"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(placeholder, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 7,
        ...
        constMeta: kCrateApiEngineClaimPersonConstMeta,
        argValues: [that, placeholder],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiEngineClaimPersonConstMeta => const TaskConstMeta(
    debugName: "Engine_claim_person",
    argNames: ["that", "placeholder"],
  );
  ...
  Future<List<String>> crateApiEngineConfirmedFriends({required Engine that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiEngineConfirmedFriendsConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiEngineConfirmedFriendsConstMeta =>
      const TaskConstMeta(
        debugName: "Engine_confirmed_friends",
        argNames: ["that"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_u_64(expiryMs, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 9,
        ...
        constMeta: kCrateApiEngineCreateFriendInviteConstMeta,
        argValues: [that, expiryMs],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiEngineCreateFriendInviteConstMeta =>
      const TaskConstMeta(
        debugName: "Engine_create_friend_invite",
        argNames: ["that", "expiryMs"],
      );
  ...
  Future<Uint8List> crateApiEngineCreateGroupInvite({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiEngineCreateGroupInviteConstMeta,
        argValues: [that, groupId, expiryMs],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiEngineCreateGroupInviteConstMeta =>
      const TaskConstMeta(
        debugName: "Engine_create_group_invite",
        argNames: ["that", "groupId", "expiryMs"],
      );
  ...
  Future<List<DeviceViewDto>> crateApiEngineListDevices({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_device_view_dto,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiEngineListDevicesConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiEngineListDevicesConstMeta =>
      const TaskConstMeta(debugName: "Engine_list_devices", argNames: ["that"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(duplicate, serializer);
        ...
        constMeta: kCrateApiEngineMergePeopleConstMeta,
        argValues: [that, duplicate, keep],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiEngineMergePeopleConstMeta => const TaskConstMeta(
    debugName: "Engine_merge_people",
    argNames: ["that", "duplicate", "keep"],
  );
  ...
  TaskConstMeta get kCrateApiEngineMyAgreementPublicConstMeta =>
      const TaskConstMeta(
        debugName: "Engine_my_agreement_public",
        argNames: ["that"],
      );
  ...
  Future<String> crateApiEngineMyDevicePublic({required Engine that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiEngineMyDevicePublicConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiEngineMyDevicePublicConstMeta =>
      const TaskConstMeta(
        debugName: "Engine_my_device_public",
        argNames: ["that"],
      );
  ...
  Future<Engine> crateApiEngineOpen({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        argValues: [dbPath, identitySeed, deviceSeed, dbKey, site],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta get kCrateApiEngineOpenConstMeta => const TaskConstMeta(
    ...
    argNames: ["dbPath", "identitySeed", "deviceSeed", "dbKey", "site"],
  );
  ...
  Future<void> crateApiEngineRevokeDevice({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiEngineRevokeDeviceConstMeta,
        argValues: [that, deviceHex],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiEngineRevokeDeviceConstMeta => const TaskConstMeta(
    debugName: "Engine_revoke_device",
    argNames: ["that", "deviceHex"],
  );
  ...
  Future<String> crateApiRecoveryPhrase({required List<int> identitySeed}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiRecoveryPhraseConstMeta,
        argValues: [identitySeed],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiRecoveryPhraseConstMeta => const TaskConstMeta(
    debugName: "recovery_phrase",
    argNames: ["identitySeed"],
  );
  ...
  Future<Uint8List> crateApiSeedFromRecoveryPhrase({required String phrase}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiSeedFromRecoveryPhraseConstMeta,
        argValues: [phrase],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiSeedFromRecoveryPhraseConstMeta =>
      const TaskConstMeta(
        debugName: "seed_from_recovery_phrase",
        argNames: ["phrase"],
      );
  ...
  Future<InviteDto?> crateApiVerifyInvite({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_opt_box_autoadd_invite_dto,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiVerifyInviteConstMeta,
        argValues: [invite, nowMs],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiVerifyInviteConstMeta => const TaskConstMeta(
    debugName: "verify_invite",
    argNames: ["invite", "nowMs"],
  );
  ...
  InviteDto dco_decode_box_autoadd_invite_dto(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_invite_dto(raw);
  }
  ...
  InviteDto dco_decode_invite_dto(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return InviteDto(
      inviter: dco_decode_String(arr[0]),
      context: dco_decode_String(arr[1]),
      expiryMs: dco_decode_u_64(arr[2]),
  ...
  List<DeviceViewDto> dco_decode_list_device_view_dto(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_device_view_dto).toList();
  }
  ...
  InviteDto? dco_decode_opt_box_autoadd_invite_dto(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_invite_dto(raw);
  }
  ...
  InviteDto sse_decode_box_autoadd_invite_dto(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_invite_dto(deserializer));
  }
  ...
  DeviceViewDto sse_decode_device_view_dto(SseDeserializer deserializer) {
    ...
    var var_site = sse_decode_u_64(deserializer);
  ...
  InviteDto sse_decode_invite_dto(SseDeserializer deserializer) {
    ...
    var var_expiryMs = sse_decode_u_64(deserializer);
    var var_valid = sse_decode_bool(deserializer);
    return InviteDto(
      inviter: var_inviter,
      context: var_context,
      expiryMs: var_expiryMs,
      valid: var_valid,
    );
  }
  ...
  List<DeviceViewDto> sse_decode_list_device_view_dto(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <DeviceViewDto>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_device_view_dto(deserializer));
    }
    return ans_;
  }
  ...
  InviteDto? sse_decode_opt_box_autoadd_invite_dto(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_invite_dto(deserializer));
    } else {
      return null;
    }
  }
  ...
  void sse_encode_box_autoadd_invite_dto(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_invite_dto(self, serializer);
  }
  ...
  @protected
  void sse_encode_device_view_dto(
    DeviceViewDto self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.device, serializer);
    sse_encode_u_64(self.site, serializer);
  ...
  void sse_encode_invite_dto(InviteDto self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.inviter, serializer);
    sse_encode_String(self.context, serializer);
    sse_encode_u_64(self.expiryMs, serializer);
  ...
  void sse_encode_list_device_view_dto(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_device_view_dto(item, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_invite_dto(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_invite_dto(self, serializer);
    }
  }
...
class EngineImpl extends RustOpaque implements Engine {
  ...
  Future<void> addFriend({required String userId}) =>
      RustLib.instance.api.crateApiEngineAddFriend(that: this, userId: userId);
  ...
  Future<void> authorizeDevice({
    required String deviceHex,
    required BigInt site,
  }) => RustLib.instance.api.crateApiEngineAuthorizeDevice(
    that: this,
    deviceHex: deviceHex,
    site: site,
  );
  ...
  Future<void> claimPerson({required String placeholder}) => RustLib
      .instance
      .api
      .crateApiEngineClaimPerson(that: this, placeholder: placeholder);

  /// The local user's confirmed (mutual) friends (#7).
  Future<List<String>> confirmedFriends() =>
      RustLib.instance.api.crateApiEngineConfirmedFriends(that: this);
  ...
  /// unlocked (#34).
  Future<Uint8List> createFriendInvite({required BigInt expiryMs}) => RustLib
      .instance
      .api
      .crateApiEngineCreateFriendInvite(that: this, expiryMs: expiryMs);
  ...
  Future<Uint8List> createGroupInvite({
    required String groupId,
    required BigInt expiryMs,
  }) => RustLib.instance.api.crateApiEngineCreateGroupInvite(
    that: this,
    groupId: groupId,
    expiryMs: expiryMs,
  );
  ...
  Future<void> mergePeople({required String duplicate, required String keep}) =>
      RustLib.instance.api.crateApiEngineMergePeople(
        that: this,
        duplicate: duplicate,
        keep: keep,
      );
  ...
  Future<String> myDevicePublic() =>
      RustLib.instance.api.crateApiEngineMyDevicePublic(that: this);
  ...
  Future<void> revokeDevice({required String deviceHex}) => RustLib.instance.api
      .crateApiEngineRevokeDevice(that: this, deviceHex: deviceHex);
